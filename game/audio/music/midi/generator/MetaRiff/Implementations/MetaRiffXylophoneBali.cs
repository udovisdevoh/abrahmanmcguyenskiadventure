...
{
    internal class MetaRiffXylophoneBali : MetaRiff
    {
        ...
        public override IEnumerable<string> GetDescriptionTagList()
        {
            ...
            descriptionTagList.Add("ethnic");
            descriptionTagList.Add("indonesian");
            descriptionTagList.Add("tribal");
            descriptionTagList.Add("world beat");
